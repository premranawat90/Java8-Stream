...
public class StreamFilter {
	...
	public static void main(String[] args) {
		 ...
		 Consumer<Student> c=stud-> System.out.println("Student Name:"+stud.getName() +"  State:"+stud.getState());
		 students.stream().filter(s->s.getState().equals("MP")).forEach(c);
		 
		 
		 System.out.println(".......................");
		//filter as per the marks to get passed student
		 Consumer<Student> passed=stud-> System.out.println("Student Name:"+stud.getName() +"  Marks:"+stud.getMarks());
